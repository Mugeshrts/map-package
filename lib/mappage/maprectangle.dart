...
class Maprectpage extends StatefulWidget {
  const Maprectpage({super.key});

  @override
  State<Maprectpage> createState() => _MappageState();
}

class _MappageState extends State<Maprectpage> {
  ...
  final double badgeWidth = 80;
  final double badgeY = 5;
  ...
  // Draw base icon
  canvas.drawImage(baseIcon, Offset(0, 50), paint);

  // 🎨 **Proper Rectangle Badge**
  final Paint badgePaint = Paint()..color = Colors.purpleAccent;
